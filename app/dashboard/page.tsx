      ...
      <div className="relative overflow-hidden border-b border-[#1e2640]">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-8">
            ...
            {/* Left: greeting */}
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#f5c51812] border border-[#f5c51828] text-[#f5c518] text-xs font-semibold mb-5">
                <span className="w-1.5 h-1.5 rounded-full bg-[#f5c518] animate-pulse" />
                FIFA World Cup 2026 · USA &amp; Canada &amp; Mexico
              </div>
              <h1 className="text-3xl sm:text-4xl font-black text-[#e8eaf0] leading-tight mb-2">
                Welcome back,{" "}
                <span
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 space-y-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {stats.map(({ label, value, icon: Icon, accent, bg }) => (
            <div
              key={label}
              className="p-4 sm:p-5 rounded-2xl border border-[#1e2640] hover:border-[#2d3a5a] transition-all duration-200"
              style={{ background: bg }}
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Link
            href="/groups"
            className="group relative overflow-hidden p-6 rounded-2xl bg-[#0e1220] border border-[#1e2640] hover:border-[#f5c51840] transition-all duration-300 cursor-pointer"
          >
            ...
            <div className="relative flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="font-bold text-[#e8eaf0] group-hover:text-[#f5c518] transition-colors mb-1">
                  Group Stage
                </h3>
          ...
          <Link
            href="/bracket"
            className="group relative overflow-hidden p-6 rounded-2xl bg-[#0e1220] border border-[#1e2640] hover:border-[#34d39940] transition-all duration-300 cursor-pointer"
          >
            ...
            <div className="relative flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="font-bold text-[#e8eaf0] group-hover:text-[#34d399] transition-colors mb-1">
                  Tournament Bracket
                </h3>
                <p className="text-sm text-[#8899bb]">
        ...
        {/* AI highlight */}
        <div className="relative overflow-hidden flex items-center gap-4 p-5 rounded-2xl border border-[#f5c51820] bg-[#0e1220]">
          <div className="absolute inset-0 bg-gradient-to-r from-[#f5c51808] via-transparent to-transparent pointer-events-none" />
          <div className="relative w-10 h-10 rounded-xl bg-[#f5c51815] flex items-center justify-center shrink-0">
            <Bot className="w-5 h-5 text-[#f5c518]" />
          </div>
          <div className="relative flex-1 min-w-0">
            <p className="text-sm font-semibold text-[#e8eaf0]">
              AI-powered predictions — instant match analysis
            </p>
          ...
          <Link
            href="/groups"
            className="relative shrink-0 flex items-center gap-1.5 px-4 py-2 rounded-xl bg-[#f5c518] text-[#080b14] text-xs font-bold hover:bg-[#fcd34d] transition-colors cursor-pointer"
          >
